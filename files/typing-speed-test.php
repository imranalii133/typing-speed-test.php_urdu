<html>
<head>
<title>Result Typing Test Online ❤️ Typing Tutor ❤️ Typing Master </title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="✅RESULT typing speed test is a free typing tutor for beginner and advanced to practice typing. RESULT typing speed tester to check your typing speed and accuracy, its fully free. use & enjoy ...!" />
<meta name="googlebot" content="✅RESULT typing speed test is a free typing tutor for beginner and advanced to practice typing. RESULT typing speed tester to check your typing speed and accuracy, its fully free. use & enjoy ...!" />
<meta name="keywords" content='result, result virtual keyboard, result onscreen keyboard, result online keyboard, google result keyboard, result typing'/>
...
<meta property="og:title" content="Result Typing Speed ❤️ Result Typing Tutor ❤️ Online Result Typing Test" />
<meta property="og:description" content="✅RESULT typing speed test is a free typing tutor for beginner and advanced to practice typing. RESULT typing speed tester to check your typing speed and accuracy, its fully free. use & enjoy ...!" />
<meta property="og:url" content="http://www.fast-typing.com/typing-speed-test.php?lan=result" /> 
<meta property="og:image" content="http://www.fast-typing.com/type/result.jpg"/>
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:url" content="http://www.fast-typing.com/typing-speed-test.php?lan=result">
<meta name="twitter:title" content="Result Typing Speed ❤️ Result Typing Tutor ❤️ Online Result Typing Test">
<meta name="twitter:description" content="✅RESULT typing speed test is a free typing tutor for beginner and advanced to practice typing. RESULT typing speed tester to check your typing speed and accuracy, its fully free. use & enjoy ...!">
<meta name="twitter:image" content="http://www.fast-typing.com/type/result.jpg">
...
<script src="files/jquery.js"></script>
	<script>	
		...
		$('#cssmenu').prepend('<div id="menu-button" style="background: #d8d8d8; color: #666">&nbsp;MAIN MENU</div>');
...
<div class="container box" style="padding: 0px">
	...
	<div style="background: #ededed">
		...
		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 left m_none" style="background: #ededed url(files/banner.jpg) no-repeat right top; padding: 15px 0 15px 0">
			<div class="ip">Result Typing Speed Test...</div>
			<div class="dateEN">Saturday, 26 August, 2023,&nbsp;Time : 3:19 PM</div>
		</div>
	<div class="clear"></div>
	</div>
...
<li class="m_none"><a href="index.php">English Typing</a></li>
<li class="m_none"><a href="typing-speed-test.php?lan=bangla">Bangla Typing</a></li>
...
<div id="contentbox">
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding: 10px 0 0 0"><!-- Languate Romanised Start -->
  <link href="files/application.css" media="all" rel="stylesheet" />
  <script src="files/application.js"></script>
		<div align="left" style="margin: 0 0 0 20px">
		<div style="text-align:left; width: 100%; padding: 30px 0 20px 0; overflow: hidden">
            <div class="content-box well">
              <div class="results-wrapper">
                <p><strong><span id="finalWPM"></span></strong> WPM <small class="text-muted">Words Per Minute</small></p>
                <p><strong><span id="finalCPM"></span></strong> CPM <small class="text-muted">Characters Per Minute</small></p>
                <p><strong><span id="finalAccuracy"></span></strong> % <small class="text-muted">Accuracy</small></p>
              </div>
            </div>
          </div>
...
<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12" style="float:left; padding: 0 0 0 0">
	<div style="margin: 0 0 10px 15px">
		<div class="ip left" onClick="custom();" style="cursor: pointer; display:none">Type with custom text</div>
		<div id="custom" class="left" style="display:none">
...
Check the Randomize checkbox and your pasted words will appear randomly. And if you do not give a tick mark, it will be written exactly.</div><script>
function custom() {
...
<div align="left" style="margin: 0 0 0 20px"><span class="sellect-ln" id="save-image-btn" onclick="#">SaveImage</span>&nbsp;<span class="sellect-ln"><a href="#" onClick="javascript:history.back();">Click for re-type</a></span></div></div></div>
				...
				<!-- SHARE THIS SCRIPT -->
					...
					.tst:hover {
						...
						border: 1px solid #666666;
										...
										<a href="typing-speed-test.php?lan=english&time=60"><div class="tst">1 Minute English typing test</div></a>
					<a href="typing-speed-test.php?lan=english&time=120"><div class="tst">2 Minute English typing test</div></a>
					<a href="typing-speed-test.php?lan=english&time=180"><div class="tst">3 Minute English typing test</div></a>
					<a href="typing-speed-test.php?lan=english&time=300"><div class="tst">5 Minute English typing test</div></a>
					<a href="typing-speed-test.php?lan=english&time=600"><div class="tst">10 Minute English typing test</div></a>
					<a href="typing-speed-test.php?lan=english&time=9000"><div class="tst">15 Minute English typing test</div></a>
					<a href="typing-speed-test.php?lan=english&time=1200"><div class="tst">20 Minute English typing test</div></a>
					<a href="typing-speed-test.php?lan=english&time=1500"><div class="tst">25 Minute English typing test</div></a>
					<a href="typing-speed-test.php?lan=english&time=1800"><div class="tst">30 Minute English typing test</div></a>
					<a href="typing-speed-test.php?lan=english&time=3600"><div class="tst">60 Minute English typing test</div></a>
					<div class="clear" style="margin: 0 0 15px 0"></div>
...
function saveTextAsFile()
{
	...
	var fileNameToSaveAs = "TypingTester__1693041575.txt";
...
function saveDocAsFile()
{
    ...
    var textToSaveAsURL = window.URL.createObjectURL(textToSaveAsBlob);
    //var fileNameToSaveAs = document.getElementById("inputFileNameToSaveAs").value;
     var fileNameToSaveAs = "TypingTester__1693041575.doc";
...
<div class="clear" style="margin: 0 0 15px 0"></div>
<div style="margin: 0 15px 0 15px"><style>
/* ========= Language Menu Start ======= */
.sellect-ln {
	margin: 0 0 12px 0;
	background: #5CB85C;
...
<div class="clear" style="margin: 0 0 10px 0">
			...
			<div>		
			<span class="sellect-ln"><a href="#switch" id="switch">Result <img border="0" src="files/arrow.png" width="10" height="6"></a></span>
			...
			<!-- </div> -->
</div></div><div class="clear" style="margin: 0 0 15px 0"></div>
